...
class editfill extends StatefulWidget {
  int i,index;
  List<Map> list1 = [];
  editfill(this.i, this.list1, this.index);


  @override
  State<editfill> createState() => _editfillState();
}

class _editfillState extends State<editfill> {
                    ...
                    onTap: () {
                      setState(() {
                        ...
                        if (name1.isEmpty) {
                          ...
                          database.updatedata(name1,comp1,title1,phone1,widget.i,db!);
  ...
  void initState() {
    ...
    comp.text = "${widget.list1[widget.index]['company']}";
